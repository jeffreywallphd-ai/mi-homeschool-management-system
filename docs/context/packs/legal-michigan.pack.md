...
Purpose: Michigan legal-reference and wording boundaries.

## Canonical Sources

- `docs/legal-requirements/michigan-homeschool-context.md`
- `docs/legal-requirements/michigan-requirement-areas.md`
- `docs/legal-requirements/requirement-mapping-rules.md`
- `docs/legal-requirements/legal-language-boundaries.md`
- `docs/legal-requirements/legal-source-refresh-workflow.md`
- `docs/legal-requirements/source-review-log.md`
- `docs/adr/ADR-0001-parent-owned-records-not-state-filings.md`
- `docs/adr/ADR-0002-michigan-as-seeded-jurisdiction-not-hardcoded-app.md`

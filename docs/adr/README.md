...
- Canonical for: architecture decision record inventory
- Related ADRs: none
- Related docs: [Documentation Governance](../README.md), [Decision Readiness Register](decision-readiness-register.md)
- Related tests: not yet implemented
- Supersedes: none

## Accepted ADRs

- [ADR-0001: Parent-Owned Records, Not State Filings](ADR-0001-parent-owned-records-not-state-filings.md)
- [ADR-0002: Michigan as Seeded Jurisdiction, Not Hardcoded App](ADR-0002-michigan-as-seeded-jurisdiction-not-hardcoded-app.md)
...
Accepted ADRs govern the decisions they record until superseded by a later accepted ADR.
